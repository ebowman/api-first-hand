...
object simple_petstore_api_yaml extends WithModel {
 ...
 def parameters = Map[ParameterRef, Parameter](
	...
	ParameterRef(	Reference("⌿paths⌿/pets⌿get⌿limit")) → Parameter("limit", Opt(Intgr(TypeMeta(Some("int32"), List("max(200.toInt, false)", "min(1.toInt, false)"))), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
