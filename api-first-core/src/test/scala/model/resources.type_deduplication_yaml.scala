...
object type_deduplication_yaml extends WithModel {
 ...
 def types = Map[Reference, Type](
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿limit") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/areas/{area_id}⌿delete⌿area_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants⌿get⌿limit") → 
		Opt(BInt(TypeMeta(None, List("""min(BigInt("10"), false)"""))), TypeMeta(None, List())),
	Reference("⌿paths⌿/users⌿post⌿signin_data") → 
		TypeDef(Reference("⌿definitions⌿SigninData"), 
			Seq(
					Field(Reference("⌿definitions⌿SigninData⌿username"), Opt(Str(None, TypeMeta(Some("Name of the new user."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿SigninData⌿password"), Opt(Str(None, TypeMeta(Some("Password of the new user."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿water_needs") → 
		TypeDef(Reference("⌿definitions⌿WaterNeeds"), 
			Seq(
					Field(Reference("⌿definitions⌿WaterNeeds⌿amount"), Opt(Str(None, TypeMeta(Some("Amount of water to be used."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿WaterNeeds⌿period"), Opt(Str(None, TypeMeta(Some("How often the plant shall be watered."), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 2"), List())),
	Reference("⌿paths⌿/users⌿get⌿offset") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿plant") → 
		TypeDef(Reference("⌿definitions⌿Plant"), 
			Seq(
					Field(Reference("⌿definitions⌿Plant⌿species"), Opt(Str(None, TypeMeta(Some("Species of the plant."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Plant⌿name"), Opt(Str(None, TypeMeta(Some("User defined name of the plant."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿put⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿put⌿user") → 
		TypeDef(Reference("⌿definitions⌿User"), 
			Seq(
					Field(Reference("⌿definitions⌿User⌿user_id"), Opt(Str(None, TypeMeta(Some("ID of the user."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿User⌿name"), Opt(Str(None, TypeMeta(Some("Display name of the user."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿offset") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/areas/{area_id}⌿get⌿area_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿limit") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/areas⌿get⌿offset") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿watering_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants⌿get⌿offset") → 
		Opt(BInt(TypeMeta(None, List("""max(BigInt("100"), false)"""))), TypeMeta(None, List())),
	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿watering_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿picture_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿delete⌿user") → 
		TypeDef(Reference("⌿definitions⌿User"), 
			Seq(
					Field(Reference("⌿definitions⌿User⌿user_id"), Opt(Str(None, TypeMeta(Some("ID of the user."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿User⌿name"), Opt(Str(None, TypeMeta(Some("Display name of the user."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿limit") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿offset") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿location") → 
		TypeDef(Reference("⌿definitions⌿Location"), 
			Seq(
					Field(Reference("⌿definitions⌿Location⌿area_id"), Opt(Str(None, TypeMeta(Some("ID of the area of the location."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Location⌿details"), Opt(Str(None, TypeMeta(Some("""Details of the location within the specified area (e.g. "desk 1" or "windowsill" )."""), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 2"), List())),
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿picture_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿delete⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/areas/{area_id}⌿put⌿area_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿picture_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿sunlight_needs") → 
		TypeDef(Reference("⌿definitions⌿SunlightNeeds"), 
			Seq(
					Field(Reference("⌿definitions⌿SunlightNeeds⌿amount"), Opt(Str(None, TypeMeta(Some("Amount of sunlight the plant need."), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 1"), List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿offset") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/areas⌿get⌿limit") → 
		Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿get⌿plant_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿get⌿user_id") → 
		Str(None, TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿get⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿SunlightNeeds"), 
			Seq(
					Field(Reference("⌿definitions⌿SunlightNeeds⌿amount"), Opt(Str(None, TypeMeta(Some("Amount of sunlight the plant need."), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 1"), List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/areas/{area_id}⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿Area"), 
			Seq(
					Field(Reference("⌿definitions⌿Area⌿area_id"), Opt(Str(None, TypeMeta(Some("ID of the area."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Area⌿building"), Opt(Str(None, TypeMeta(Some("Name of the building."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/areas⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿201") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿put⌿responses⌿201") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/areas/{area_id}⌿delete⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿WaterNeeds"), 
			Seq(
					Field(Reference("⌿definitions⌿WaterNeeds⌿amount"), Opt(Str(None, TypeMeta(Some("Amount of water to be used."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿WaterNeeds⌿period"), Opt(Str(None, TypeMeta(Some("How often the plant shall be watered."), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 2"), List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants⌿get⌿responses⌿200") → 
		ArrResult(TypeDef(Reference("⌿definitions⌿Plant"), 
			Seq(
					Field(Reference("⌿definitions⌿Plant⌿species"), Opt(Str(None, TypeMeta(Some("Species of the plant."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Plant⌿name"), Opt(Str(None, TypeMeta(Some("User defined name of the plant."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Plant⌿description"), Opt(Str(None, TypeMeta(Some("User defined description of the plant."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/areas/{area_id}⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/areas⌿get⌿responses⌿200") → 
		ArrResult(TypeDef(Reference("⌿definitions⌿Area"), 
			Seq(
					Field(Reference("⌿definitions⌿Area⌿area_id"), Opt(Str(None, TypeMeta(Some("ID of the area."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Area⌿building"), Opt(Str(None, TypeMeta(Some("Name of the building."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Area⌿floor"), Opt(Str(None, TypeMeta(Some("Name of the floor."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/me⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿User"), 
			Seq(
					Field(Reference("⌿definitions⌿User⌿user_id"), Opt(Str(None, TypeMeta(Some("ID of the user."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿User⌿name"), Opt(Str(None, TypeMeta(Some("Display name of the user."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/areas/{area_id}⌿put⌿responses⌿201") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿Location"), 
			Seq(
					Field(Reference("⌿definitions⌿Location⌿area_id"), Opt(Str(None, TypeMeta(Some("ID of the area of the location."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Location⌿details"), Opt(Str(None, TypeMeta(Some("""Details of the location within the specified area (e.g. "desk 1" or "windowsill" )."""), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 2"), List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿responses⌿200") → 
		ArrResult(TypeDef(Reference("⌿definitions⌿Plant"), 
			Seq(
					Field(Reference("⌿definitions⌿Plant⌿species"), Opt(Str(None, TypeMeta(Some("Species of the plant."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Plant⌿name"), Opt(Str(None, TypeMeta(Some("User defined name of the plant."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}⌿get⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/areas/{area_id}⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users⌿post⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/me⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/areas/{area_id}⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿delete⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/areas/{area_id}⌿delete⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿Watering"), 
			Seq(
					Field(Reference("⌿definitions⌿Watering⌿watering_id"), Opt(Str(None, TypeMeta(Some("Id of the watering."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Watering⌿user_id"), Opt(Str(None, TypeMeta(Some("Id of the user responsible for watering this plant."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿201") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿201") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿Plant"), 
			Seq(
					Field(Reference("⌿definitions⌿Plant⌿species"), Opt(Str(None, TypeMeta(Some("Species of the plant."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Plant⌿name"), Opt(Str(None, TypeMeta(Some("User defined name of the plant."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿get⌿responses⌿200") → 
		TypeDef(Reference("⌿definitions⌿User"), 
			Seq(
					Field(Reference("⌿definitions⌿User⌿user_id"), Opt(Str(None, TypeMeta(Some("ID of the user."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿User⌿name"), Opt(Str(None, TypeMeta(Some("Display name of the user."), List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}⌿delete⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿responses⌿404") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿responses⌿200") → 
		ArrResult(TypeDef(Reference("⌿definitions⌿Watering"), 
			Seq(
					Field(Reference("⌿definitions⌿Watering⌿watering_id"), Opt(Str(None, TypeMeta(Some("Id of the watering."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Watering⌿user_id"), Opt(Str(None, TypeMeta(Some("Id of the user responsible for watering this plant."), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Watering⌿date"), Opt(Str(None, TypeMeta(Some("Date of the last time the plant was watered."), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 3"), List())), TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿201") → 
		Null(TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿responses⌿404") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿responses⌿200") → 
		Null(TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{user_id}⌿delete⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
	...
	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿responses⌿default") → 
		TypeDef(Reference("⌿definitions⌿Error"), 
			Seq(
					Field(Reference("⌿definitions⌿Error⌿code"), Opt(Intgr(TypeMeta(Some("int32"), List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Error⌿message"), Opt(Str(None, TypeMeta(None, List())), TypeMeta(None, List()))),
 ...
 def parameters = Map[ParameterRef, Parameter](
	...
	ParameterRef(	Reference("⌿paths⌿/areas⌿get⌿offset")) → Parameter("offset", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	ParameterRef(	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿limit")) → Parameter("limit", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	ParameterRef(	Reference("⌿paths⌿/users⌿post⌿signin_data")) → Parameter("signin_data", TypeDef(Reference("⌿definitions⌿SigninData"), 
			Seq(
		Field(Reference("⌿definitions⌿SigninData⌿username"), Opt(Str(None, TypeMeta(Some("Name of the new user."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿SigninData⌿password"), Opt(Str(None, TypeMeta(Some("Password of the new user."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿SigninData⌿email"), Opt(Str(None, TypeMeta(Some("E-mail address of the new user."), List())), TypeMeta(None, List())))
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿water_needs")) → Parameter("water_needs", TypeDef(Reference("⌿definitions⌿WaterNeeds"), 
			Seq(
		Field(Reference("⌿definitions⌿WaterNeeds⌿amount"), Opt(Str(None, TypeMeta(Some("Amount of water to be used."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿WaterNeeds⌿period"), Opt(Str(None, TypeMeta(Some("How often the plant shall be watered."), List())), TypeMeta(None, List())))
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿location")) → Parameter("location", TypeDef(Reference("⌿definitions⌿Location"), 
			Seq(
		Field(Reference("⌿definitions⌿Location⌿area_id"), Opt(Str(None, TypeMeta(Some("ID of the area of the location."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿Location⌿details"), Opt(Str(None, TypeMeta(Some("""Details of the location within the specified area (e.g. "desk 1" or "windowsill" )."""), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 2"), List())), None, None, ".+", encode = false, ParameterPlace.withName("body")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿offset")) → Parameter("offset", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿offset")) → Parameter("offset", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿limit")) → Parameter("limit", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿limit")) → Parameter("limit", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/users⌿get⌿offset")) → Parameter("offset", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}⌿put⌿user")) → Parameter("user", TypeDef(Reference("⌿definitions⌿User"), 
			Seq(
		Field(Reference("⌿definitions⌿User⌿user_id"), Opt(Str(None, TypeMeta(Some("ID of the user."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿User⌿name"), Opt(Str(None, TypeMeta(Some("Display name of the user."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿User⌿area_id"), Opt(Str(None, TypeMeta(Some("Id of the area where the user is usually located."), List())), TypeMeta(None, List())))
	...
	ParameterRef(	Reference("⌿paths⌿/areas⌿get⌿limit")) → Parameter("limit", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	ParameterRef(	Reference("⌿paths⌿/users⌿get⌿limit")) → Parameter("limit", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿sunlight_needs")) → Parameter("sunlight_needs", TypeDef(Reference("⌿definitions⌿SunlightNeeds"), 
			Seq(
		Field(Reference("⌿definitions⌿SunlightNeeds⌿amount"), Opt(Str(None, TypeMeta(Some("Amount of sunlight the plant need."), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 1"), List())), None, None, ".+", encode = false, ParameterPlace.withName("body")),
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}⌿put⌿plant")) → Parameter("plant", TypeDef(Reference("⌿definitions⌿Plant"), 
			Seq(
		Field(Reference("⌿definitions⌿Plant⌿species"), Opt(Str(None, TypeMeta(Some("Species of the plant."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿Plant⌿name"), Opt(Str(None, TypeMeta(Some("User defined name of the plant."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿Plant⌿description"), Opt(Str(None, TypeMeta(Some("User defined description of the plant."), List())), TypeMeta(None, List()))),
		...
		Field(Reference("⌿definitions⌿Plant⌿plant_id"), Opt(Str(None, TypeMeta(Some("Unique identifier representing a plant."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿Plant⌿godparent"), Opt(Str(None, TypeMeta(Some("ID of the godparent of this plant. Can be empty if no godparent is assigned"), List())), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 6"), List())), None, None, ".+", encode = false, ParameterPlace.withName("body")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants⌿get⌿offset")) → Parameter("offset", Opt(BInt(TypeMeta(None, List("""max(BigInt("100"), false)"""))), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/users/{user_id}⌿delete⌿user")) → Parameter("user", TypeDef(Reference("⌿definitions⌿User"), 
			Seq(
		Field(Reference("⌿definitions⌿User⌿user_id"), Opt(Str(None, TypeMeta(Some("ID of the user."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿User⌿name"), Opt(Str(None, TypeMeta(Some("Display name of the user."), List())), TypeMeta(None, List()))),
		Field(Reference("⌿definitions⌿User⌿area_id"), Opt(Str(None, TypeMeta(Some("Id of the area where the user is usually located."), List())), TypeMeta(None, List())))
	...
	ParameterRef(	Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿offset")) → Parameter("offset", Opt(BInt(TypeMeta(None, List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/plants⌿get⌿limit")) → Parameter("limit", Opt(BInt(TypeMeta(None, List("""min(BigInt("10"), false)"""))), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
...
def calls: Seq[ApiCall] = Seq(
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿waterings⌿{watering_id}")), 
		...
		TypesResponseInfo(
			...
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿plants⌿{plant_id}⌿waterings⌿{watering_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿200")),
			201 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿201")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings/{watering_id}⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					201 -> Self,
	...
	ApiCall(GET, Path(Reference("⌿users⌿me")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/me⌿get⌿responses⌿200"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/me⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿sunlight_needs")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿plants⌿{plant_id}⌿sunlight_needs")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/sunlight_needs⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿users")), 
		...
		), Some(	ParameterRef(Reference("⌿paths⌿/users⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(POST, Path(Reference("⌿users")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users⌿post⌿responses⌿200"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users⌿post⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(GET, Path(Reference("⌿areas⌿{area_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿get⌿responses⌿200"))
		), Some(	ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(PUT, Path(Reference("⌿areas⌿{area_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿put⌿responses⌿200")),
			201 -> ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿put⌿responses⌿201"))
		), Some(	ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					201 -> Self
	...
	ApiCall(DELETE, Path(Reference("⌿areas⌿{area_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿delete⌿responses⌿200"))
		), Some(	ParameterRef(Reference("⌿paths⌿/areas/{area_id}⌿delete⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(GET, Path(Reference("⌿plants")), 
		...
		), Some(	ParameterRef(Reference("⌿paths⌿/plants⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(GET, Path(Reference("⌿user⌿{user_id}⌿plants")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/user/{user_id}/plants⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿users⌿{user_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿users⌿{user_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿put⌿responses⌿200")),
			201 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿put⌿responses⌿201"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					201 -> Self
	...
	ApiCall(DELETE, Path(Reference("⌿users⌿{user_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿delete⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿delete⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/{user_id}⌿delete⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿areas")), 
		...
		), Some(	ParameterRef(Reference("⌿paths⌿/areas⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿location")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿plants⌿{plant_id}⌿location")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(DELETE, Path(Reference("⌿plants⌿{plant_id}⌿location")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/location⌿delete⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿users⌿{user_id}⌿picture")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿users⌿{user_id}⌿picture")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿200")),
			201 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿201")),
			404 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					201 -> Self,
	...
	ApiCall(DELETE, Path(Reference("⌿users⌿{user_id}⌿picture")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/users/{user_id}/picture⌿delete⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿pictures")), 
		...
		TypesResponseInfo(
			...
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿plants⌿{plant_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿200")),
			201 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿201")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					201 -> Self,
	...
	ApiCall(DELETE, Path(Reference("⌿plants⌿{plant_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}⌿delete⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿waterings")), 
		...
		TypesResponseInfo(
			...
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/waterings⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿pictures⌿{picture_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(PUT, Path(Reference("⌿plants⌿{plant_id}⌿pictures⌿{picture_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿200")),
			201 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿201")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					201 -> Self,
	...
	ApiCall(DELETE, Path(Reference("⌿plants⌿{plant_id}⌿pictures⌿{picture_id}")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/pictures/{picture_id}⌿delete⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
	...
	ApiCall(GET, Path(Reference("⌿plants⌿{plant_id}⌿water_needs")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿get⌿responses⌿200"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿get⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self
			), Some(Self)), 
	...
	ApiCall(PUT, Path(Reference("⌿plants⌿{plant_id}⌿water_needs")), 
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			200 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿responses⌿200")),
			404 -> ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿responses⌿404"))
		), Some(	ParameterRef(Reference("⌿paths⌿/plants/{plant_id}/water_needs⌿put⌿responses⌿default")))), 
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
					404 -> Self
