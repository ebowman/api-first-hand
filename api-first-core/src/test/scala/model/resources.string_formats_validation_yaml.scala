...
object string_formats_validation_yaml extends WithModel {
 ...
 def types = Map[Reference, Type](
	...
	Reference("⌿paths⌿/string⌿post⌿responses⌿200") → 
		Null(TypeMeta(None, List()))
) 
 ...
 def parameters = Map[ParameterRef, Parameter](
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿password_optional")) → Parameter("password_optional", Opt(Password(TypeMeta(Some("password"), List("maxLength(10)", "minLength(0)", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿binary_optional")) → Parameter("binary_optional", Opt(BinaryString(TypeMeta(Some("binary"), List("maxLength(110)", "minLength(10)", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), TypeMeta(None, List())), None, None, ".+", encode = false, ParameterPlace.withName("body")),
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿date_optional")) → Parameter("date_optional", Opt(Date(TypeMeta(Some("date"), List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿base64optional")) → Parameter("base64optional", Opt(Base64String(TypeMeta(Some("byte"), List("maxLength(10)", "minLength(0)", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿string_optional")) → Parameter("string_optional", Opt(Str(None, TypeMeta(None, List("maxLength(10)", "minLength(0)", """pattern("""+"""""""""+"""/[1-9][A-Z0-9]*/"""+"""""""""+""".r)"""))), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/string⌿post⌿date_time_optional")) → Parameter("date_time_optional", Opt(DateTime(TypeMeta(Some("date-time"), List())), TypeMeta(None, List())), None, None, ".+", encode = true, ParameterPlace.withName("query"))
) 
