...
object split_petstore_api_yaml extends WithModel {
 ...
 def types = Map[Reference, Type](
	...
	Reference("⌿paths⌿/pets⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/pets⌿post⌿body⌿Option⌿Pet")), TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{username}⌿put⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Option⌿User")), TypeMeta(None, List())),
	Reference("⌿paths⌿/stores/order⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/stores/order⌿post⌿body⌿Option⌿Order")), TypeMeta(None, List())),
	Reference("⌿paths⌿/pets/{petId}⌿delete⌿petId") → 
		Lng(TypeMeta(Some("int64"), List())),
	Reference("⌿paths⌿/users/createWithList⌿post⌿body") → 
		Opt(ArrResult(TypeRef(Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Option⌿User")), TypeMeta(None, List())), TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/pets/findByStatus⌿get⌿responses⌿200") → 
		ArrResult(TypeRef(Reference("⌿paths⌿/pets⌿post⌿body⌿Option⌿Pet")), TypeMeta(None, List())),
	Reference("⌿definitions⌿Pet⌿category⌿Option⌿Category") → 
	...
	Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Option⌿User") → 
	...
	Reference("⌿paths⌿/pets⌿post⌿body⌿Option⌿Pet") → 
		TypeDef(Reference("⌿definitions⌿Pet"), 
			Seq(
					...
					Field(Reference("⌿definitions⌿Pet⌿tags"), Opt(ArrResult(TypeRef(Reference("⌿definitions⌿Pet⌿category⌿Option⌿Category")), TypeMeta(None, List())), TypeMeta(None, List()))),
					Field(Reference("⌿definitions⌿Pet⌿category"), Opt(TypeRef(Reference("⌿definitions⌿Pet⌿category⌿Option⌿Category")), TypeMeta(None, List())))
			), TypeMeta(Some("Named types: 6"), List())),
	Reference("⌿paths⌿/stores/order⌿post⌿body⌿Option⌿Order") → 
 ...
 def parameters = Map[ParameterRef, Parameter](
	...
	ParameterRef(	Reference("⌿paths⌿/users/login⌿get⌿password")) → Parameter("password", TypeRef(Reference("⌿paths⌿/users/login⌿get⌿username")), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/users/login⌿get⌿username")) → Parameter("username", TypeRef(Reference("⌿paths⌿/users/login⌿get⌿username")), None, None, ".+", encode = true, ParameterPlace.withName("query")),
...
def calls: Seq[ApiCall] = Seq(
	...
	ApiCall(POST, Path(Reference("⌿stores⌿order")),
		...
		TypesResponseInfo(
			Map[Int, ParameterRef](
			400 -> ParameterRef(Reference("⌿paths⌿/users/createWithList⌿post⌿responses⌿default")),
			200 -> ParameterRef(Reference("⌿paths⌿/stores/order⌿post⌿body⌿Option⌿Order"))
		), None),
		StateResponseInfo(
				Map[Int, State](
					200 -> Self,
	...
	ApiCall(GET, Path(Reference("⌿users⌿{username}")),
		...
		TypesResponseInfo(
			...
			400 -> ParameterRef(Reference("⌿paths⌿/users/createWithList⌿post⌿responses⌿default")),
			200 -> ParameterRef(Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Option⌿User"))
		), None),
		StateResponseInfo(
				Map[Int, State](
					404 -> Self,
	...
	ApiCall(GET, Path(Reference("⌿pets⌿{petId}")),
		...
		TypesResponseInfo(
			...
			404 -> ParameterRef(Reference("⌿paths⌿/users/createWithList⌿post⌿responses⌿default")),
			400 -> ParameterRef(Reference("⌿paths⌿/users/createWithList⌿post⌿responses⌿default")),
			200 -> ParameterRef(Reference("⌿paths⌿/pets⌿post⌿body⌿Option⌿Pet"))
		), None),
		StateResponseInfo(
				Map[Int, State](
					404 -> Self,
