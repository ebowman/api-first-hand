...
object split_petstore_api_yaml extends WithModel {
 ...
 def types = Map[Reference, Type](
	...
	Reference("⌿definitions⌿Pet⌿category") → 
		Opt(TypeRef(Reference("⌿definitions⌿Pet⌿category⌿Opt")), TypeMeta(None, List())),
	...
	Reference("⌿paths⌿/pets⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/pets⌿post⌿body⌿Opt")), TypeMeta(None, List())),
	Reference("⌿paths⌿/users/{username}⌿put⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/users/{username}⌿put⌿body⌿Opt")), TypeMeta(None, List())),
	Reference("⌿paths⌿/stores/order⌿post⌿body") → 
		Opt(TypeRef(Reference("⌿paths⌿/stores/order⌿post⌿body⌿Opt")), TypeMeta(None, List())),
	...
	Reference("⌿definitions⌿Pet⌿tags⌿Opt") → 
		ArrResult(TypeRef(Reference("⌿definitions⌿Pet⌿category⌿Opt")), TypeMeta(None, List())),
