...
object uber_api_yaml extends WithModel {
	...
	Reference("⌿definitions⌿Activities") → 
		TypeDef(Reference("⌿definitions⌿Activities"), 
			Seq(
					...
					Field(Reference("⌿definitions⌿Activities⌿history"), Opt(ArrResult(TypeRef(Reference("⌿definitions⌿Activity")), TypeMeta(None, List())), TypeMeta(None, List())))
 ...
 def parameters = Map[ParameterRef, Parameter](
	...
	ParameterRef(	Reference("⌿paths⌿/history⌿get⌿limit")) → Parameter("limit", TypeRef(Reference("⌿paths⌿/history⌿get⌿limit")), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/estimates/time⌿get⌿product_id")) → Parameter("product_id", TypeRef(Reference("⌿paths⌿/estimates/time⌿get⌿product_id")), None, None, ".+", encode = true, ParameterPlace.withName("query")),
	...
	ParameterRef(	Reference("⌿paths⌿/history⌿get⌿offset")) → Parameter("offset", TypeRef(Reference("⌿paths⌿/history⌿get⌿limit")), None, None, ".+", encode = true, ParameterPlace.withName("query"))
) 
